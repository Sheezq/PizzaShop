        ...
        <div class="login-card">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="email" class="auth-form " type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                ...
                <div class="form-group">
                    ...
                    <x-text-input id="password" class="auth-form " type="password" name="password" required autocomplete="current-password" />
